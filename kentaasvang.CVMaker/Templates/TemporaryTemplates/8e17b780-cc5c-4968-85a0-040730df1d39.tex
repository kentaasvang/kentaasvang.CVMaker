...
\cvname{Kent Martin Åsvang} % Your name
\cvjobtitle{qwdqwd} % Job title/career

\cvdate{9-20-2023} % Date of birth
\cvaddress{norsk} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{81549300} % Phone number
\cvmail{kent@kent.kent} % Email address
\cvsite{http://www.kent.no}
\cvsiteb{http://www.kent.no} % Personal website
...
\aboutme{hello you little bitch mutha} % To have no About Me section, just remove all the text and leave \aboutme{}
