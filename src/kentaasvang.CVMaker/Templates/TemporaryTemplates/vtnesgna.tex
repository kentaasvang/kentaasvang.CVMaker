...
\cvname{Kent Åsvang} % Your name
\cvjobtitle{Senior Utvikler} % Job title/career

\cvdate{3-7-1988} % Date of birth
\cvaddress{Norsk} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{48 36 51 56} % Phone number
\cvmail{kent@asvang.no} % Email address
\cvsite{http://linkedin.com}
\cvsiteb{https://blog.asvang.no} % Personal website
...
\aboutme{Jeg er 35 år og er pittelitt redd for edderkopper.} % To have no About Me section, just remove all the text and leave \aboutme{}
