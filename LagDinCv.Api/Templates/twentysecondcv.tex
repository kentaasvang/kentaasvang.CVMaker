...
\\cvjobtitle{[jobtitle]} % Job title/career

\\cvdate{[dayofbirth]} % Date of birth
\\cvaddress{[nationality]} % Short address/location, use \\newline if more than 1 line is required
\\cvnumberphone{[phonenumber]} % Phone number
\\cvmail{[emailaddress]} % Email address
\\cvsite{[linkedin]}
\\cvsiteb{[website]} % Personal website
...
\\aboutme{[about]} % To have no About Me section, just remove all the text and leave \\aboutme{}
